...
process.env.E2E_PROJECT = 'E2E Automation Tests';
process.env.E2E_REPORT_FOLDER =
    'E2E' + '_' + initial.format('DD-MM-YYYY_HH-mm-ss');
process.env.E2E_FRONTEND_URL = url;

const dirPath = '.tmp/' + process.env.E2E_REPORT_FOLDER;
